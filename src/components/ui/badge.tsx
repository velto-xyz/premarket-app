...
const badgeVariants = cva(
  ...
  "inline-flex items-center rounded-[4px] border px-2 py-0.5 text-xs font-normal font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
